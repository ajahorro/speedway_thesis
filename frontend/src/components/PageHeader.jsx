...
const PageHeader = ({ badge, title, subtitle, onRefresh, showBack, onBack, children }) => (
  <div className="stack-on-mobile" style={{ justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2.5rem' }}>
    <div>
      ...
      <h1 className="text-fluid-h1" style={{ margin: 0, letterSpacing: '-1.5px', color: 'var(--admin-text-primary)', lineHeight: 1.1 }}>{title}</h1>
